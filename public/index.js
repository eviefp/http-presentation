...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Data.User"] = $PS["Data.User"] || {};
  var exports = $PS["Data.User"];
  var Simple_JSON = $PS["Simple.JSON"];
  var readForeignUserId = Simple_JSON.readInt;
  exports["readForeignUserId"] = readForeignUserId;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
...
(function($PS) {
  ...
  var Data_Symbol = $PS["Data.Symbol"];
  var Data_Unit = $PS["Data.Unit"];
  var Data_User = $PS["Data.User"];
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];
  var Simple_JSON = $PS["Simple.JSON"];                
  var getUsers = function (dictMonadAff) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT((dictMonadAff.MonadEffect0()).Monad0()))(Control_Monad_Except_Trans.ExceptT(Data_Functor.map(((((dictMonadAff.MonadEffect0()).Monad0()).Bind1()).Apply0()).Functor0())(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Function["const"](Data_Unit.unit)))(Effect_Aff_Class.liftAff(dictMonadAff)(Affjax.get(Affjax_ResponseFormat.string)("/api/user")))))(function (res) {
          var v = Simple_JSON.readJSON(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "userId";
          }))(Data_User.readForeignUserId)(Simple_JSON.readFieldsNil)()())()())))(res.body);
          if (v instanceof Data_Either.Right) {
              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT((dictMonadAff.MonadEffect0()).Monad0()))(v.value0);
          };
          if (v instanceof Data_Either.Left) {
              return Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT((dictMonadAff.MonadEffect0()).Monad0()))(Data_Unit.unit);
          };
          throw new Error("Failed pattern match at API (line 23, column 5 - line 25, column 35): " + [ v.constructor.name ]);
      });
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Component.Index"] = $PS["Component.Index"] || {};
  var exports = $PS["Component.Index"];
  var API = $PS["API"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Except_Trans = $PS["Control.Monad.Except.Trans"];
  ...
  var renderUser = function (user) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(user.name) ]);
  };
  var render = function (st) {
      if (st.users instanceof Data_Maybe.Nothing) {
          return Halogen_HTML_Core.text("Loading...");
      };
      if (st.users instanceof Data_Maybe.Just) {
          return Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderUser)(st.users.value0));
      };
      throw new Error("Failed pattern match at Component.Index (line 37, column 5 - line 41, column 39): " + [ st.users.constructor.name ]);
  };
  var handleAction = function (dictMonadAff) {
      return function (v) {
          if (v instanceof Initialize) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(Data_Monoid.mempty(Data_Monoid.monoidUnit))(Halogen_Query_HalogenM.fork(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Except_Trans.runExceptT(API.getUsers(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))))(function (v1) {
                  if (v1 instanceof Data_Either.Left) {
                  ...
                  if (v1 instanceof Data_Either.Right) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $11.users = new Data_Maybe.Just(v1.value0);
                          return $11;
                      });
                  };
                  throw new Error("Failed pattern match at Component.Index (line 59, column 25 - line 61, column 69): " + [ v1.constructor.name ]);
              })));
          };
          if (v instanceof Delete) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          throw new Error("Failed pattern match at Component.Index (line 55, column 5 - line 62, column 30): " + [ v.constructor.name ]);
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
          initialState: Data_Function["const"]({
              users: Data_Maybe.Nothing.value
          }),
          render: render,
...
(function($PS) {
  ...
  $PS["Main"] = $PS["Main"] || {};
  var exports = $PS["Main"];
  var Component_Index = $PS["Component.Index"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Component_Index.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();